...
var QuizeComponent = (function () {
    function QuizeComponent(quizeService) {
        var _this = this;
    ...
    QuizeComponent.prototype.addCour = function () {
        var _this = this;
        var newCour = {
            nom: this.nom,
    ...
    QuizeComponent.prototype.deleteCour = function (id) {
    ...
    QuizeComponent.prototype.updateCour = function () {
        var _this = this;
    ...
    QuizeComponent.prototype.f = function (cour) {
        this.envoie = cour;
        this.envoie_to_add = cour;
    };
    QuizeComponent.prototype.g = function (cour, ti) {
        this.envoie_to_add = cour;
        this.titre_a_modifier = ti;
    };
    QuizeComponent.prototype.dima = function (cour, ti, text) {
        this.envoie_to_add = cour;
        this.titre_a_modifier = ti;
        this.text = text;
        console.log("yaaaa ");
    ...
    QuizeComponent.prototype.addContenue = function () {
        var _this = this;
    ...
    QuizeComponent.prototype.addQuize = function () {
        var _this = this;
        this._cour = new Cour_1.Cour(this.envoie_to_add.nom, this.envoie_to_add.description);
        this._cour._id = this.envoie_to_add._id;
    ...
    QuizeComponent.prototype.addQuestion = function () {
        var _this = this;
        this._cour = new Cour_1.Cour(this.envoie_to_add.nom, this.envoie_to_add.description);
        this._cour._id = this.envoie_to_add._id;
    ...
    QuizeComponent.prototype.addChoie = function () {
        var _this = this;
    ...
    return QuizeComponent;
}());
exports.QuizeComponent = QuizeComponent;
//# sourceMappingURL=quize.component.js.map